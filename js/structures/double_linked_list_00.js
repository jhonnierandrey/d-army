...
// doubleList.insertAt(9, 2)

console.log(doubleList.removeData())

// console.log(doubleList.removeFromHead());
// console.log(doubleList.removeFromTail());

console.log(doubleList.getSize());
console.log(doubleList.isEmpty());

console.log(doubleList.print());
console.log(doubleList.reversePrint());
